"gradient" by Quinton Reeves
    CC-BY-SA 3.0 license. Created using the gradient fill tool in GIMP.
    
"stars" by Quinton Reeves
    CC-BY-SA 3.0 license. Created with Starbox 1.9 by Alex Grigny de Castro from the included xgStars.txt.

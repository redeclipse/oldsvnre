...
GSVAR(IDF_ADMIN, capturemaps, "ares bath biolytic canals cargo center colony conflict cutec darkness deadsimple deli depot dropzone dutility echo erosion foundation fourplex futuresport ghost industrial institute isolation keystone2k linear mist nova panic pumpstation stone tribal venus warp wet");
GSVAR(IDF_ADMIN, defendmaps, "ares bath biolytic canals cargo center colony conflict cutec darkness deadsimple deli depot dropzone dutility echo erosion foundation fourplex futuresport ghost industrial institute isolation keystone2k linear mist nova panic processing pumpstation stone tower tribal ubik venus warp wet");
GSVAR(IDF_ADMIN, kingmaps, "ares bath biolytic canals cargo center colony conflict darkness deadsimple depot dropzone dutility echo fourplex futuresport industrial linear processing stone tower tribal ubik venus");
GSVAR(IDF_ADMIN, bombermaps, "ares bath biolytic canals cargo center colony conflict cutec darkness deadsimple deli depot dropzone dutility echo erosion foundation fourplex futuresport ghost industrial isolation linear mist nova pumpstation stone tower tribal venus warp wet");
GSVAR(IDF_ADMIN, holdmaps, "ares bath biolytic canals cargo center colony conflict cutec darkness deadsimple deli depot dropzone dutility echo erosion foundation fourplex futuresport ghost industrial isolation keystone2k linear mist nova panic processing pumpstation stone tower tribal ubik venus warp wet");
...
GSVAR(IDF_ADMIN, largemaps, "ares biolytic blink canals cargo center colony cutec dawn deadsimple deathtrap deli depot erosion facility forge foundation futuresport ghost industrial isolation lab linear mist nova processing pumpstation spacetech tower tranquility tribal ubik venus warp");
#endif

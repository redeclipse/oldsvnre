...
GSVAR(IDF_ADMIN, kingmaps, "ares bath biolytic cargo center colony conflict darkness deadsimple depot dropzone dutility echo fourplex futuresport industrial linear processing stone tower tribal ubik venus");

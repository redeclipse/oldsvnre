...
GSVAR(IDF_ADMIN, allowmaps, "alphacampaign bath bloodgrounds darkness deadsimple deathtrap deli depot dutility enigma forge ghost hinder hollow keystone longestyard mist nova panic smouldering spacetech stone testchamber tower tranquility venus warp");
GSVAR(IDF_ADMIN, mainmaps, "bath bloodgrounds darkness deadsimple deathtrap deli depot enigma ghost keystone longestyard mist nova panic smouldering spacetech stone tower tranquility warp wet venus");
GSVAR(IDF_ADMIN, duelmaps, "bath darkness deadsimple dutility keystone longestyard panic venus");
...
GFVAR(0, movespeed, 0, 80.f, 1000); // speed
GFVAR(0, movecrawl, 0, 0.5f, 1000); // crawl modifier
GFVAR(0, impulsespeed, 0, 80.f, 1000); // extra velocity to add when impulsing

...
GSVAR(IDF_ADMIN, jetpackmaps, "alphacampaign bath darkness dawn deadsimple deathtrap deli depot dropzone dutility echo enigma forge foundation futuresport ghost hinder keystone linear longestyard mist nova panic spacetech stone testchamber tranquility tribal ubik venus warp");

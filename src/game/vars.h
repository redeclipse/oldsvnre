...
GVAR(IDF_ADMIN, demolock, 0, PRIV(OPERATOR), PRIV(MAX));
...
GVAR(IDF_ADMIN, allowlock, 0, PRIV(OPERATOR), PRIV(MAX));
GVAR(IDF_ADMIN, banlock, 0, PRIV(OPERATOR), PRIV(MAX));
GVAR(IDF_ADMIN, mutelock, 0, PRIV(MODERATOR), PRIV(MAX));
GVAR(IDF_ADMIN, limitlock, 0, PRIV(MODERATOR), PRIV(MAX));
GVAR(IDF_ADMIN, vetolock, 0, PRIV(OPERATOR), PRIV(MAX));
GVAR(IDF_ADMIN, editlock, 0, PRIV(OPERATOR), PRIV(MAX));
...
GVAR(IDF_ADMIN, campaignplayers, 1, 4, MAXPLAYERS);
#endif
GSVAR(IDF_ADMIN, allowmaps, "ares bath battlefield biolytic canals cargo center colony conflict cutec cyanide darkness deadsimple deathtrap deli depot dropzone dutility echo erosion error forge foundation 4plex futuresport ghost hawk hinder institute isolation keystone2k linear longestyard mist neodrive nova oneiroi panic processing pumpstation purge spacetech starlibido stone suspended testchamber tower tranquility tribal ubik venus warp wet");

GSVAR(IDF_ADMIN, mainmaps, "ares bath battlefield biolytic canals cargo center colony conflict cutec darkness deadsimple deathtrap deli depot dropzone dutility echo erosion error foundation 4plex futuresport ghost institute isolation keystone2k linear longestyard mist nova oneiroi panic processing pumpstation spacetech starlibido stone suspended tower tribal ubik venus warp wet");
GSVAR(IDF_ADMIN, capturemaps, "ares bath battlefield biolytic canals cargo center colony conflict cutec darkness deadsimple deli depot dropzone dutility echo erosion foundation 4plex futuresport ghost institute isolation keystone2k linear mist nova panic pumpstation stone suspended tribal venus warp wet");
GSVAR(IDF_ADMIN, defendmaps, "ares bath battlefield biolytic canals cargo center colony conflict cutec darkness deadsimple deli depot dropzone dutility echo erosion foundation 4plex futuresport ghost institute isolation keystone2k linear mist nova panic processing pumpstation stone suspended tower tribal ubik venus warp wet");
GSVAR(IDF_ADMIN, kingmaps, "ares bath battlefield biolytic canals cargo center colony conflict darkness deadsimple depot dropzone dutility echo 4plex futuresport linear processing stone suspended tower tribal ubik venus");
GSVAR(IDF_ADMIN, bombermaps, "ares bath battlefield biolytic canals cargo center colony conflict cutec darkness deadsimple deli depot dropzone dutility echo erosion foundation 4plex futuresport ghost isolation linear mist nova pumpstation stone suspended tower tribal venus warp wet");
GSVAR(IDF_ADMIN, holdmaps, "ares bath battlefield biolytic canals cargo center colony conflict cutec darkness deadsimple deli depot dropzone dutility echo erosion foundation 4plex futuresport ghost isolation keystone2k linear mist nova panic processing pumpstation stone suspended tower tribal ubik venus warp wet");
GSVAR(IDF_ADMIN, trialmaps, "cyanide hawk hinder neodrive purge testchamber");
GSVAR(IDF_ADMIN, gauntletmaps, "cyanide testchamber");

GSVAR(IDF_ADMIN, multimaps, "canals deadsimple depot keystone2k warp isolation 4plex"); // applies to modes which *require* multi spawns (ctf/bb)
GSVAR(IDF_ADMIN, duelmaps, "bath darkness deadsimple dutility echo 4plex ghost longestyard starlibido stone panic wet");
GSVAR(IDF_ADMIN, jetpackmaps, "ares battlefield biolytic canals cargo center colony conflict cutec darkness deadsimple deathtrap deli depot dropzone dutility echo erosion error forge 4plex futuresport ghost isolation linear longestyard mist nova oneiroi pumpstation spacetech starlibido suspended testchamber tower tranquility tribal ubik venus warp");

GSVAR(IDF_ADMIN, smallmaps, "bath darkness deadsimple dutility echo error 4plex ghost longestyard starlibido stone panic wet");
GSVAR(IDF_ADMIN, mediummaps, "ares battlefield biolytic canals cargo center colony conflict cutec darkness deadsimple deathtrap deli dropzone echo erosion error forge foundation 4plex futuresport ghost institute isolation keystone2k linear mist nova oneiroi panic processing pumpstation spacetech suspended starlibido stone tower tranquility tribal ubik venus warp wet");
GSVAR(IDF_ADMIN, largemaps, "ares battlefield biolytic canals cargo center colony cutec deadsimple deathtrap deli depot erosion forge foundation futuresport ghost isolation linear mist nova processing pumpstation spacetech suspended tower tranquility tribal ubik venus warp");
#endif
...
GVAR(IDF_ADMIN, varslock, 0, PRIV2(OPERATOR), PRIV2(MAX));
GVAR(IDF_ADMIN, votelock, 0, PRIV2(OPERATOR), PRIV2(MAX));

...
GSVAR(IDF_ADMIN, capturemaps, "ares bath battlefield biolytic canals cargo center colony conflict cutec darkness deadsimple deli depot dropzone dutility echo erosion foundation fourplex futuresport ghost industrial institute isolation keystone2k linear mist nova panic pumpstation stone tribal venus warp wet");
GSVAR(IDF_ADMIN, defendmaps, "ares bath battlefield biolytic canals cargo center colony conflict cutec darkness deadsimple deli depot dropzone dutility echo erosion foundation fourplex futuresport ghost industrial institute isolation keystone2k linear mist nova panic processing pumpstation stone tower tribal ubik venus warp wet");
GSVAR(IDF_ADMIN, kingmaps, "ares bath battlefield biolytic canals cargo center colony conflict darkness deadsimple depot dropzone dutility echo fourplex futuresport industrial linear processing stone tower tribal ubik venus");
GSVAR(IDF_ADMIN, bombermaps, "ares bath battlefield biolytic canals cargo center colony conflict cutec darkness deadsimple deli depot dropzone dutility echo erosion foundation fourplex futuresport ghost industrial isolation linear mist nova pumpstation stone tower tribal venus warp wet");
GSVAR(IDF_ADMIN, holdmaps, "ares bath battlefield biolytic canals cargo center colony conflict cutec darkness deadsimple deli depot dropzone dutility echo erosion foundation fourplex futuresport ghost industrial isolation keystone2k linear mist nova panic processing pumpstation stone tower tribal ubik venus warp wet");
...
GSVAR(IDF_ADMIN, jetpackmaps, "ares battlefield biolytic canals cargo center colony conflict cutec darkness dawn deadsimple deathtrap deli depot dropzone dutility echo erosion error forge fourplex futuresport ghost isolation linear longestyard mist nova oneiroi pumpstation spacetech starlibido testchamber tower tranquility tribal ubik venus warp");
...
GSVAR(IDF_ADMIN, mediummaps, "ares battlefield biolytic blink canals cargo center colony conflict cutec darkness deadsimple deathtrap deli dropzone echo erosion error facility forge foundation fourplex futuresport ghost industrial institute isolation keystone2k lab linear mist nova oneiroi panic processing pumpstation spacetech starlibido stone tower tranquility tribal ubik venus warp wet");
GSVAR(IDF_ADMIN, largemaps, "ares battlefield biolytic blink canals cargo center colony cutec dawn deadsimple deathtrap deli depot erosion facility forge foundation futuresport ghost industrial isolation lab linear mist nova processing pumpstation spacetech tower tranquility tribal ubik venus warp");
#endif
...
GVAR(IDF_ADMIN, votelock, 0, 2, 7); // 0 = off, 1-3 = helper/moderator/administrator can select prevmaps, 4 = helper/moderator/administrator only can vote, 7 = no voting

...
GVAR(0, botbalance, -2, -2, INT_MAX-1); // -2 = numplayers only when alone -1 = always use numplayers, 0 = don't balance, 1 or more = fill only with this*numteams
...
GFVAR(0, impulseboost, 0, 1.15f, 1000); // thrust modifier
GFVAR(0, impulsedash, 0, 1.35f, 1000); // dashing modifier
GFVAR(0, impulsejump, 0, 1.25f, 1000); // jump modifier
GFVAR(0, impulsemelee, 0, 0.5f, 1000); // melee modifier
GFVAR(0, impulseparkour, 0, 1.15f, 1000); // parkour modifier
...
GVAR(0, impulseskate, 0, 2000, INT_MAX-1); // length of time a run along a wall can last
GFVAR(0, impulsesprint, 0, 0, 1000); // sprinting impulse meter depletion
GFVAR(0, impulsejetpack, 0, 2.f, 1000); // jetpack impulse meter depletion
...
GFVAR(0, impulseregenjetpack, 0, 2.f, 1000); // impulse regen jetpack modifier
...
GFVAR(0, stillspread, 0, 2.f, 1000);
GFVAR(0, movespread, 0, 4.f, 1000);
GFVAR(0, inairspread, 0, 4.f, 1000);
GFVAR(0, impulsespread, 0, 8.f, 1000);

...
GSVAR(IDF_ADMIN, mainmaps, "bath bloodgrounds darkness deadsimple deathtrap deli depot echo enigma forge futuresport ghost keystone longestyard mainframe mist nova panic smouldering spacetech stone tower tranquility warp wet venus");
GSVAR(IDF_ADMIN, duelmaps, "bath darkness deadsimple dutility echo longestyard mainframe panic venus");
GSVAR(IDF_ADMIN, ctfmaps, "bath darkness deadsimple deli depot echo enigma forge futuresport ghost keystone mist nova panic smouldering stone tranquility warp wet venus");
GSVAR(IDF_ADMIN, stfmaps, "bath bloodgrounds darkness deadsimple deli depot echo enigma forge futuresport ghost keystone mist nova panic smouldering stone tower tranquility warp wet venus");
...
GFVAR(0, jumpspeed, 0, 110.f, 1000); // extra velocity to add when jumping
GFVAR(0, impulsespeed, 0, 110.f, 1000); // extra velocity to add when impulsing
GFVAR(0, impulselimit, 0, 220.f, 10000); // maximum impulse speed
GFVAR(0, impulseboost, 0, 1.f, 1000); // thrust modifier
GFVAR(0, impulsedash, 0, 1.4f, 1000); // dashing modifier
GFVAR(0, impulsejump, 0, 1.2f, 1000); // jump modifier

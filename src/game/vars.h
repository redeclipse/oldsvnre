...
GSVAR(IDF_ADMIN, bombermaps, "ares bath biolytic canals cargo center colony conflict darkness deadsimple deli depot dropzone dutility echo foundation fourplex futuresport ghost industrial isolation linear mist nova pumpstation stone tower tribal venus warp wet");

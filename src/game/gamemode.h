...
enum
{
    ...
    G_M_ROTATE = (1<<G_M_FFA)|(1<<G_M_INSTA),
...
#define m_swapteam(a,b)     (m_team(a, b) && !m_trial(a) && m_fight(a) && !m_duel(a, b) && !m_coop(gamemode, mutators) && G(teambalance) >= 3 && G(teambalanceswap))
#define m_balteam(a,b,c)    (m_team(a, b) && !m_trial(a) && m_fight(a) && !m_duel(a, b) && !m_coop(gamemode, mutators) && G(teambalance) >= c)

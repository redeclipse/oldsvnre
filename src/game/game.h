...
namespace client
{
    ...
    extern bool sendplayerinfo, sendcrcinfo, sendgameinfo, demoplayback, isready, waitplayers;
...
namespace hud
{
    extern char *chattex, *insigniatex, *playertex, *deadtex, *waitingtex, *spectatortex, *editingtex, *dominatingtex, *dominatedtex, *inputtex, *bliptex, *pointtex, *flagtex, *bombtex, *arrowtex, *alerttex, *questiontex, *flagdroptex, *flagtakentex, *bombdroptex, *bombtakentex, *attacktex,

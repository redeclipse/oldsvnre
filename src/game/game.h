...
enum
{
    ...
    N_MASTERMODE, N_CONTROL, N_CLRCONTROL, N_CURRENTMASTER, N_SPECTATOR, N_WAITING, N_SETMASTER, N_SETTEAM,
...
char msgsizelookup(int msg)
{
    static const int msgsizes[] =               // size inclusive message token, 0 for variable or not-checked sizes
    {
        ...
        N_MASTERMODE, 2, N_CONTROL, 3, N_CLRCONTROL, 2, N_CURRENTMASTER, 3, N_SPECTATOR, 3, N_WAITING, 2, N_SETMASTER, 0, N_SETTEAM, 0,

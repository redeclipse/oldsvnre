...
enum
{
    ...
    G_M_FILTER = G_M_TEAM|G_M_INSTA|G_M_MEDIEVAL|G_M_BALLISTIC|G_M_DUEL|G_M_SURVIVOR|G_M_ARENA|G_M_ONSLAUGHT|G_M_JETPACK|G_M_VAMPIRE|G_M_RESIZE|G_M_GSP1|G_M_GSP2|G_M_GSP3,
...
teamtypes teamtype[] = {
    {
        TEAM_NEUTRAL,   0x669911,           "neutral",
        "team",             "\fG",      "green"
    },
    {
        TEAM_ALPHA,     0x8888FF,           "alpha",
        "teamalpha",        "\fb",      "blue"
    },
    {

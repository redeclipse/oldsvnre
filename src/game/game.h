...
enum
{
    ...
    S_DEBRIS, S_TINK, S_RICOCHET, S_WHIZZ, S_BEEP, S_EXPLODE, S_ENERGY, S_HUM, S_BURN,
    S_BURNING, S_BURNFIRE, S_EXTINGUISH, S_BZAP, S_BZZT,
    S_SWITCH, S_SHELL, S_SHELL2, S_SHELL3, S_SHELL4, S_SHELL5, S_SHELL6,
    S_MELEE, S_MELEE2, S_MELEE_R, S_MELEE_N,
    S_PISTOL, S_PISTOL2, S_PISTOL_R, S_PISTOL_N,
    S_SWORD, S_SWORD2, S_SWORD_R, S_SWORD_N,
    S_SHOTGUN, S_SHOTGUN2, S_SHOTGUN_R, S_SHOTGUN_N,
    S_SMG, S_SMG2, S_SMG_R, S_SMG_N,
    S_FLAMER, S_FLAMER2, S_FLAMER_R, S_FLAMER_N,
    S_PLASMA, S_PLASMA2, S_PLASMA_R, S_PLASMA_N,
    S_RIFLE, S_RIFLE2, S_RIFLE_R, S_RIFLE_N,
    S_GRENADE, S_GRENADE2, S_GRENADE_R, S_GRENADE_N,
    S_ROCKET, S_ROCKET2, S_ROCKET_R, S_ROCKET_N,
...
enum { S_R_DIE = 2, S_R_PAIN = 6, S_R_SPLOSH = 3, S_R_SHELL = 6, S_R_DAMAGE = 8 };
enum { S_W_PRIMARY = 0, S_W_ALTERNATE, S_W_RELOAD, S_W_NOTIFY };

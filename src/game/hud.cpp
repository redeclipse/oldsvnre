...
namespace hud
{
    ...
    TVAR(IDF_PERSIST, tasercrosshairtex, "crosshairs/circle-03", 3);
    TVAR(IDF_PERSIST, taserhithairtex, "crosshairs/circle-03-hit", 3);
    ...
    TVAR(IDF_PERSIST|IDF_GAMEPRELOAD, tasertex, "<grey>textures/weapons/taser", 3);
    ...
    TVAR(IDF_PERSIST|IDF_GAMEPRELOAD, tasercliptex, "<grey>textures/weapons/clips/taser", 3);
    ...
    FVAR(IDF_PERSIST, taserclipskew, 0, 0.55f, 10);
    ...
    VAR(IDF_PERSIST, tasercliprotate, 0, 12, 15);
            ...
            case POINTER_HAIR:
            {
                if(crosshairweapons&1 && isweap(weap))
                {
                    const char *crosshairtexs[W_MAX] = {
                        ...
                        flamercrosshairtex, plasmacrosshairtex, tasercrosshairtex, riflecrosshairtex, grenadecrosshairtex, minecrosshairtex,
            ...
            case POINTER_HIT:
            {
                if(crosshairweapons&1 && isweap(weap))
                {
                    const char *hithairtexs[W_MAX] = {
                        ...
                        flamerhithairtex, plasmahithairtex, taserhithairtex, riflehithairtex, grenadehithairtex, minehithairtex,
    ...
    void drawclip(int weap, int x, int y, float s)
    {
        ...
        const char *cliptexs[W_MAX] = {
            ...
            flamercliptex, plasmacliptex, tasercliptex, riflecliptex, grenadecliptex, minecliptex, rocketcliptex
        };
        const float clipoffs[W_MAX] = {
            meleeclipoffset, pistolclipoffset, swordclipoffset, shotgunclipoffset, smgclipoffset,
            flamerclipoffset, plasmaclipoffset, taserclipoffset, rifleclipoffset, grenadeclipoffset, mineclipoffset, rocketclipoffset
        };
        const float clipskew[W_MAX] = {
            meleeclipskew, pistolclipskew, swordclipskew, shotgunclipskew, smgclipskew,
            flamerclipskew, plasmaclipskew, taserclipskew, rifleclipskew, grenadeclipskew, mineclipskew, rocketclipskew
        };
        const int cliprots[W_MAX] = {
            meleecliprotate, pistolcliprotate, swordcliprotate, shotguncliprotate, smgcliprotate,
            flamercliprotate, plasmacliprotate, tasercliprotate, riflecliprotate, grenadecliprotate, minecliprotate, rocketcliprotate
        };
